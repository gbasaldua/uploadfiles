		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload File",
									"targetURL": "#gbasdeveloperuploadfiles-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gbasdeveloperuploadfiles-display": {
								"semanticObject": "gbasdeveloperuploadfiles",
								"action": "display",
								"description": "Upload File Fiori application.",
								"title": "Upload File",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gbas.developer.uploadfiles",
									"url": sap.ui.require.toUrl("gbas/developer/uploadfiles")
								}
							}
						}
					}
